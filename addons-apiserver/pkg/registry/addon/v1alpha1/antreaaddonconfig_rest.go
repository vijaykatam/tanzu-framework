...
func (r *AntreaAddonConfigREST) List(ctx context.Context, options *metainternalversion.ListOptions) (runtime.Object, error) {
	secrets, err := r.client.CoreV1().Secrets(request.NamespaceValue(ctx)).List(ctx, metav1.ListOptions{LabelSelector: "tkg.tanzu.vmware.com/addon-name: antrea"})
	if err != nil {
		return nil, err
	}
	var antreaAddonConfigs []v1alpha1.AntreaAddonConfig
